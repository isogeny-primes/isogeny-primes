...
# faster then the current sage implementation
...
def monkey_patch():
    abelian_group = sage.groups.abelian_gps.abelian_group
    abelian_group.AbelianGroup_subgroup.__contains__ = __contains__

    number_field = sage.rings.number_field.number_field
